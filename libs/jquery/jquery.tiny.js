define([
    ...
    $.extend($.support, {
        html5: {
            canvas: 'undefined' != typeof HTMLCanvasElement
        }
    });
    ...
    (function() {
        ...
        function handler(event) {
            ...
            else if ( event.originalEvent.wheelDelta ) delta = event.originalEvent.wheelDelta/120;

            event.pageX = event.originalEvent.pageX || event.originalEvent.clientX;
            event.pageY = event.originalEvent.pageY || event.originalEvent.clientY;
